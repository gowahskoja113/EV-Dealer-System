...
public class ServiceRecordController {
    ...
    @GetMapping
    public Page<ServiceRecordResponse> list(
    ...
    public Page<ServiceRecordResponse> byCustomer(
    ...
    public Page<ServiceRecordResponse> byService(
            @PathVariable Long serviceId,
            @PageableDefault(size = 20) Pageable p) {
        return service.byServiceEntity(serviceId, p);
    }

    @GetMapping("/by-user/{userId}")
    public Page<ServiceRecordResponse> byUser(
    ...
    public ServiceRecordResponse create(@Valid @RequestBody ServiceRecordRequest req) {
    ...
    public ServiceRecordResponse update(
            ...
            @Valid @RequestBody ServiceRecordUpdateRequest req) {
